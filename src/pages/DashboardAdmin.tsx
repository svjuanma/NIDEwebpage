...
const [searchBar, setSearchBar] = useState(false)
  ...
  return (
    <div className={dashboard.home}>
      ...
      <div className={dashboard.card}><Card title="Solicitudes pendientes" desc="Total de solicitudes no aceptadas" value={String(metricasTotales.solicitudes)} icon={users}/></div>
